...
<body>
	<form action="send" method="post" >
		<table border="1">
			...
			<tr>
				<td >이름 : <input type="text" name="name" size="20" id="a"  value="123"></td>
			</tr>
			...
			<tr>
				<td>낙서장: <textarea rows="1" cols="30" name="memo" value="qwe">
				</textarea>
				</td>
			</tr>

			<tr>
				<td>전화번호 : <input name="telno1" maxlength="3" value="123">-
					<input name="telno2" maxlength="4" value="1231">- <input
					name="telno3" maxlength="4"  value="1234">
				</td>
			</tr>
